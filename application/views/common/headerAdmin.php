...
<html lang="en">
  <head>
    ...
    <script src="<?php echo base_url('assets/bootstrap/js/bootstrap.min.js')?>"></script>
	  ...
	  <script src="<?php echo base_url('assets/jquery-validation/dist/additional-methods.min.js'); ?>"></script>
	  <script src="<?php echo base_url('assets/jquery-validation/dist/validate.js'); ?>"></script>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm bg-primary navbar-dark">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" role="button" href="<?php echo base_url('Admin');?>">Admin</a>
        </li>
      </ul>
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" role="button" href="<?php echo base_url('Examinee');?>">Examinee</a>
        </li>
      </ul>
      <ul class="navbar-nav">
        <li class="nav-item ">
          <a class="nav-link" role="button" href="<?php echo base_url('Category');?>">Category</a>
        </li>
      </ul>
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" role="button" href="<?php echo base_url('Question');?>">Question</a>
        </li>
      </ul>
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" role="button" href="<?php echo base_url('SchoolYear');?>">School Year</a>
        </li>
      </ul>
      <ul class="navbar-nav">
        <li class="nav-item">
